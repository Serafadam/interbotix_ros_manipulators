...
def launch_setup(context, *args, **kwargs):
    ...
    controllers_yaml = load_yaml('interbotix_xsarm_moveit', f'config/controllers/{dof.perform(context)}dof_controllers.yaml')
    ...
    rviz_node = Node(package='rviz2',
                     ...
                     parameters=[robot_description,
                                 ...
                                 ompl_planning_pipeline_config,
                                 kinematics_yaml])
    ros_control_prefix = os.path.join(get_package_share_directory("interbotix_xsarm_ros_control"))
